  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.socialPosts.create({
      ...
      platform_configurations: {
        bluesky: { caption: {}, media: [{ url: 'url', thumbnail_timestamp_ms: {}, thumbnail_url: {} }] },
        facebook: {
          caption: {},
          media: [{ url: 'url', thumbnail_timestamp_ms: {}, thumbnail_url: {} }],
          placement: 'reels',
        ...
        linkedin: { caption: {}, media: [{ url: 'url', thumbnail_timestamp_ms: {}, thumbnail_url: {} }] },
        pinterest: {
          board_ids: ['string'],
          caption: {},
          link: 'link',
        ...
        x: { caption: {}, media: [{ url: 'url', thumbnail_timestamp_ms: {}, thumbnail_url: {} }] },
        youtube: {
          caption: {},
          media: [{ url: 'url', thumbnail_timestamp_ms: {}, thumbnail_url: {} }],
          title: 'title',
