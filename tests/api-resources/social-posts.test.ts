  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.socialPosts.create({
      ...
      platform_configurations: {
        ...
        facebook: { caption: {}, media: ['string'], placement: 'reels' },
        instagram: { caption: {}, collaborators: ['string'], media: ['string'], placement: 'reels' },
        linkedin: { caption: {}, media: ['string'] },
        pinterest: { board_ids: ['string'], caption: {}, link: 'link', media: ['string'] },
        threads: { caption: {}, media: ['string'], placement: 'reels' },
        tiktok: {
          allow_comment: true,
          allow_duet: true,
          allow_stitch: true,
