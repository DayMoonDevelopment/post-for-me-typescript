...
describe('resource webhooks', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.webhooks.create({ event_types: ['social.post.created'], url: 'url' });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.webhooks.create({ event_types: ['social.post.created'], url: 'url' });
  });
