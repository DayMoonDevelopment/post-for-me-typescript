...
export { ClientOptions } from 'post-for-me';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/post-for-me',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the post-for-me MCP server. You will use Code Mode to help the user perform
