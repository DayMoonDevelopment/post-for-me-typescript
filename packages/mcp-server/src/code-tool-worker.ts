...
import { PostForMe, ClientOptions } from 'post-for-me';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: PostForMe)`
    : `const run: (${functionSource.client}: PostForMe) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.socialPosts.delete',
    'client.socialPosts.list',
    'client.socialPosts.retrieve',
    'client.socialPosts.update',
    'client.socialPostResults.list',
    'client.socialPostResults.retrieve',
    'client.socialAccounts.create',
    'client.socialAccounts.createAuthURL',
    'client.socialAccounts.disconnect',
